...
//
// Unknown custom element: <the-subscription-navbar> - did you register the component
...
app({
  ...
  template: `<div id="admin" class="crust"><the-subscription-navbar /><router-view/></div>`,
})
